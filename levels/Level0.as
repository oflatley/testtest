package levels {
	class Level0 implements ILevelData {
		public function get data() : Array { return _data; }
		private static const _data : Array = [

//			{ type: "PlatformMedium_15",					x:0,				y: 520},
			
			{ type: "PlatformShort_elev",				x: 400, 			y: 500},			
			...
			{ type: "PlatformMedium_0",					x: 2131,				y: 355},
			{ type: "Trampoline",					x: 1740,				y: 336},
			{ type: "Brain",					x: 767,				y: 160},
			{ type: "Brain",					x: 999,				y: 319},
			{ type: "Brain",					x: 1091,				y: 338},
			{ type: "Token_MakePlayerSmaller",					x: 414,				y: 455},
			{ type: "Token_MakePlayerBigger",					x: 570,				y: 611},
